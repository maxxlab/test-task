...
const customcolor1 = Color(0xFF009497);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF009497),
  customcolor1: Color(0xFF00696C),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFF6FF6FA),
  onCustomcolor1Container: Color(0xFF002021),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF009497),
  customcolor1: Color(0xFF4CDADD),
  onCustomcolor1: Color(0xFF003738),
  customcolor1Container: Color(0xFF004F51),
  onCustomcolor1Container: Color(0xFF6FF6FA),
);
